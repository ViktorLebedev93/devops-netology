# Домашнее задание к занятию «Основы Git» - Лебедев Виктор FOPS-33
...
Зарегистрировался в GitLab. Ссылка на профиль: https://gitlab.com/viktorlebedev931
Создал публичный репозиторий devops-netology: https://gitlab.com/viktorlebedev931/devops-netology
README.md не добавлял при создании репозитория.
Аккаунт регистрировал самостоятельный, с введением логина и пароля. Ключ SSH создал и добавил в настройки профиля:

![img1](img1.jpg)

Посмотрел предлагаемые в профиле команды в секции Command line instructions.
...
Проверяю изменения в выводе команды git remote -v:

![img4](img4.jpg)

Отправил изменения в новый удалённый репозиторий
...
Переключаемся на main (мы уже в ней) и смотрим лог коммитов

![img12](img12.jpg)

Используем команду git checkout с найденным хешем

![img13](img13.jpg)

Создаем ветку fix на основании коммита и пушим ее в github

![img14](img14.jpg)

Появилась ветка fix начинающаяся с выбранного коммита

![img15](img15.jpg)

Возвращаемся в main, вносим изменения в README.md и отправляем изменения в github

![img16](img16.jpg)

Main ушла вперед а fix осталась на месте

![img17](img17.jpg)

Разница в логах на разных ветках (показывает что ветки живут независимо)
...
Установил PyCharm и авторизовался в репозитории. Сделал клон. Внес изменение в readme. PyCharm обнаружил изменение

![img19](img19.jpg)

Есть кнопка создания коммита и пуша.

![img20](img20.jpg)

Коммит и пуш применены
